...
export class InvitationController{
  ...
  @Get()
   ...
   async Delete(
     @Param('id') id,
     @Body() Invitation:invitation,hist:history,org:organizations){
    const invitations = await this.invitationService.findInv(id);
    ...
    const histories = await this.invitationService.deleteInv(id,Invitation)
    //await pullOrg.save()
    //await pullUser.save()
